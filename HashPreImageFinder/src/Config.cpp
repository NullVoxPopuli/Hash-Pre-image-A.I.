...
int unsigned Config::LAYERS[] = {HASH_WIDTH_IN_BITS, HASH_WIDTH_IN_BITS, HASH_WIDTH_IN_BITS, HASH_WIDTH_IN_BITS, 1};

int Config::MAX_EPOCHS = 300;
int Config::REPORT_EVERY = 100;
